...
*/
/*
- declare a variable 'dup' and initialize to empty object
- iterate through the parameter array
  - if the element already exist as object property
    - return the element
  - if not 
    - add the element to object property as set the value as 0
*/

function findDup (arr) {
  let dup = {}; 
  arr.forEach((ele) => {
    if (dup.hasOwnProperty(ele)) {
      console.log(ele);
    } else {
      dup[ele] = 0;
    }
